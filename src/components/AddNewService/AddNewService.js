...
const AddNewService = () => {
    ...
    return (
        <form onSubmit={handleNewService} className="hero min-h-screen bg-base-200">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input name='picture' type="text" placeholder="Service Photo URL" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span name="price" className="label-text">Offered Price/hr</span>
                            </label>
                            <input name='price' type="text" placeholder="Your offerings" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span name="about" className="label-text">Details About the Service</span>
                            </label>
                            <textarea name="about" className='bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white' placeholder='Please include service details' id="" cols="30" rows="10"></textarea>
